<div data-index="{$i}" class="hidden" data-group="sellers">
    ...
    <h3>Seller {$i}</h3><br>
    <div class="row">
        {include file="widgets/tags.tpl" class="col-sm-12" direction="horizontal" label="Type of seller" name="seller-type{$i}"
        value="Person"
    ...
    <div class="row" data-visible="Company" data-group="seller">
        {include file="widgets/input.tpl" label="Zip Code" name="seller-company-address-zipcode{$i}"
    ...
    <div class="row">
        {include file="widgets/input.tpl" label="Interpreter required for which language?" class="col-sm-12" name="seller-interpreter_language{$i}"
        parentProps=["data-visible" => "Yes", "data-group" => "interpreter"]}
        {include file="widgets/input.tpl" label="What physical limitations do you have?" class="col-sm-12" name="seller-physical_limitation{$i}"
